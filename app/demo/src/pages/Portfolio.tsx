    ...
    <div className="flex items-center justify-between gap-4 py-3">
      ...
      <div className="flex items-center gap-3">
        <PriceTicker
          ...
          quote={holding.quote as Currency}
...
export default function Portfolio() {
  ...
  return (
    <div className="space-y-6 p-6 md:p-8">
      <PageHeading
        title="Portfolio"
        subtitle="Track the live value of your crypto holdings."
      />
      ...
      <Card className="p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Pick an asset and enter how much you hold — its value updates in real
          time.
        </p>
        <div className="mt-4">
